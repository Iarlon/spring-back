...
2. **Configure o banco de dados:**
   ...
   - Altere as configurações em [`src/main/resources/application.properties`](api/src/main/resources/application.properties) se necessário.
...
- **Script para criar pessoas via Postman:**  
  <img src="./assets/scriptCriarPessoa.png" alt="Script criar pessoa" width="600">
